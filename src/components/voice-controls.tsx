...
export function VoiceControls({
  ...
  return (
    <div className="flex flex-col gap-4">
        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          <div className="relative flex-1">
            ...
            <Button
              ...
              disabled={!textInput.trim() || isProcessing || isAssistantSpeaking}
            >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      isDetectingSpeech
                       ...
                       (isProcessing || isAssistantSpeaking) && "opacity-50 cursor-not-allowed" // Style when disabled
                    )}
                  >
                    {isDetectingSpeech ? (
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      disabled={isDetectingSpeech || isProcessing || isAssistantSpeaking} // Also disable if detecting speech
                      className="rounded-full border-zed-200 dark:border-zed-700 disabled:opacity-50"
                    >
      ...
      <div className="text-xs text-center text-zed-400 dark:text-zed-500 h-4"> {/* Added fixed height */}
        {isProcessing
